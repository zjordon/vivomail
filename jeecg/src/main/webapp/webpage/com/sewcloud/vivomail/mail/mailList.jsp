	  ...
	  <table border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover" id="table_bug_report">
	    <thead>
	      <tr>
	        ...
	        <th width="60" class="hidden-480">归档时间</th>
	    ...
	    <tbody>
	      <tr>
	        ...
	        <td>21454</td>
	        <td><a href='#' data-rel="tooltip" title="12.7-大数据联盟-页面1">12.7-大数据联盟-页面1-3</a></td>
	        <td><a href="#1">大数据联盟会议</a></td>
	        <td><a href="#1">大数据联盟会议启动前推广</a></td>
	      ...
	      <tr>
	        <td class='center'><label>
	          ...
	          <span class="lbl"></span></label></td>
	        <td>41243</td>
	        <td><a href='#' data-rel="tooltip" title="12.7-大数据联盟-页面1-2">12.7-大数据联盟-页面1-2</a></td>
	        <td><a href="#1">大数据联盟会议</a></td>
	        <td><a href="#1">大数据联盟会议启动前推广</a></td>
	        <td class='hidden-480'><span class='label label-success'>编辑中</span></td>
	        <td class='hidden-480'>27</td>
	        <td class='hidden-480 muted'><span style="font-size:12px">2013-12-05 15:52</span></td>
	        <td class='hidden-480 muted'><span style="font-size:12px">2013-12-07 00:00</span></td>
	        <td><div class="inline position-relative">
	          <button class="btn btn-minier btn-primary dropdown-toggle" data-toggle="dropdown"><i class="icon-cog icon-only"></i></button>
	      ...
	      <tr>
	        <td class='center'><label>
	          ...
	          <span class="lbl"></span></label></td>
	        <td>14543</td>
	        <td><a href='#' data-rel="tooltip" title="12.7-大数据联盟-页面1-1">12.7-大数据联盟-页面1-1</a></td>
	        <td><a href="#1">大数据联盟会议</a></td>
	        <td><a href="#1">大数据联盟会议启动前推广</a></td>
	      ...
	      <tr>
	        <td class='center'><label>
	          ...
	          <span class="lbl"></span></label></td>
	        <td>56743</td>
	        <td><a href='#' data-rel="tooltip" title="博士眼镜测试-搜狐">博士眼镜测试-搜狐</a></td>
	        <td><a href="#1">搜狐EDM推广</a></td>
	        <td><a href="#1">搜狐双11推广</a></td>
	        <td class='hidden-480'><span class='label'>已归档</span></td>
	        <td class='hidden-480'>16</td>
	        <td class='hidden-480 muted'><span style="font-size:12px">2013-12-05 15:52</span></td>
	        <td class='hidden-480 muted'><span style="font-size:12px">2013-12-07 00:00</span></td>
	        <td><div class="inline position-relative">
	          <button class="btn btn-minier btn-primary dropdown-toggle" data-toggle="dropdown"><i class="icon-cog icon-only"></i></button>
	      ...
	      <tr>
	        <td class='center'><label>
	          ...
	          <span class="lbl"></span></label></td>
	        <td>86434</td>
	        <td><a href='#' data-rel="tooltip" title="创维项目页面3-2">创维项目页面3-2</a></td>
	        <td><a href="#1">创维</a></td>
	        <td><a href="#1">创维电视11.11推广</a></td>
	      ...
	      <tr>
	        <td class='center'><label>
	          ...
	          <span class="lbl"></span></label></td>
	        <td>86434</td>
	        <td><a href='#' data-rel="tooltip" title="创维项目页面3-6">创维项目页面3-6</a></td>
	        <td><a href="#1">创维</a></td>
	        <td><a href="#1">创维电视11.11推广</a></td>
...
<!-- 新建邮件1 -->
<DIV tabindex="-1" class="modal2 fade" id="newmail" role="dialog">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table border="0" cellspacing="0" cellpadding="0" align="center">
	    <tr>
	      <td height="30"><strong>邮件归属：</strong></td>
	      </tr>
	    <tr>
	      <td><!-- 项目分类筛选 -->
	        <select name="form-field-select-" class="chzn-select" id="form-field-select-5" data-placeholder="请选择项目">
	          <option value=""></option>
	          <option value='AL'>万利达春季活动</option>
	          <option value='AK'>大势电商</option>
	          <option value='AZ'>湖南特产</option>
	    ...
	    <tr>
	      <td height="30"><strong>邮件行业标签：</strong></td>
	      </tr>
	    <tr>
	      <td><!-- 一级标签 -->
...
<!-- 新建邮件2 开始 -->
<DIV tabindex="-1" class="modal2 fade" id="newmail2" role="dialog">
  <DIV class="modal-dialog">
    <DIV class="modal-content">
      <DIV class="modal-header">
        <BUTTON class="close2" aria-hidden="true" type="button" data-dismiss="modal">×</BUTTON>
...
<input type="radio" name="radio3" value="wanzheng" checked="checked" />
完整 
...
<tr id="wanzheng">
<td><table width="300" border="0" cellpadding="3" cellspacing="1" class="text-12px-333" bgcolor="#CCCCCC">
<tr class="bg-fcfcfc-e8e8e8">
<th scope="col" width="50%">首先内容</th>
<th scope="col" width="50%">映射字段</th>
</tr>
<tr>
...
<td class="text-12px-333">域信息：
<input type="radio" name="radio5" id="radio5" value="radio5" />
有 
<input type="radio" name="radio6" id="radio6" value="radio6" />
无</td>
</tr>
</table><!-- End .content-box -->
      </DIV>
      <DIV class="modal-footer">
        <BUTTON class="btn btn-primary" type="button" id="submitBut2" data-dismiss="modal">开始匹配</BUTTON>
      </DIV>
    </DIV>
    <!-- /.modal-content --> 
  </DIV>
...
<!-- 新建邮件3 开始 -->
<DIV tabindex="-1" class="modal2 fade" id="newmail3" role="dialog">
  <DIV class="modal-dialog">
    <DIV class="modal-content">
      <DIV class="modal-header">
        <BUTTON class="close2" aria-hidden="true" type="button" data-dismiss="modal">×</BUTTON>
      ...
      <DIV class="modal-body" id="model-body">
        <font class=' text-14px-333'>开始梳理成功，系统已在后台帮您进行匹配或过滤操作。这个过程需要一段时间，系统完成后将邮件通知您，您可以继续其他操作。<br /><br />
		您的邮件地址为：<span class="text-14px-f3463e">xxxx@xxxx.com</span></font>
      </DIV>
      <DIV class="modal-footer">

...
<table width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr class="page-header">
    <td><button class="btn btn-small2 btn-warning" href="#moban" data-toggle="modal"><i class="icon-envelope"></i> 新建模版</button>
...
<table border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover" id="table_bug_report">
  <thead>
    <tr>
      ...
      <th width="50">活动ID</th>
      <th>邮件名称</th>
      <th width="100" class="hidden-480">建立时间</th>
      <th width="100" class="hidden-480">更新时间</th>
      <th width="20"></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>21454</td>
      <td><a href="#moban" data-toggle="modal">12.13-大数据联盟-页面1-8</a></td>
  ...
  <DIV class="modal-dialog">
    <DIV class="modal-content">
      <DIV class="modal-header">
        ...
        <H4 class="modal-title">新建模版：</H4>
      </DIV>
      <DIV class="modal-body">
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr>
        <td width="80" align="right"><strong>模版名称：</strong></td>
        <td><input type="text" id="form-field-2" placeholder="请输入模版名称" class="span4"></td>
      </tr>
      <tr>
        <td align="right"><strong>上传模版：</strong></td>
        <td><table width="367" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="bottom"><input type="file" id="id-input-file-1" /></td>
            <td width="80" align="right" valign="top"><button class="btn btn-small2 btn-info" > <i class="icon-cloud-upload"></i> 上传</button></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td align="right"><strong>退订样式：</strong></td>
        <td><select name="select2" class="text-12px-333 span4" id="select2">
      ...
      <tr>
        <td colspan="2">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="200" align="center" bgcolor="#CCCCCC"><h1>这里放编辑器</h1><br>
</td>
            </tr>
          </table>
        </td>
...
<DIV tabindex="-1" class="modal2 fade" id="shanchu" role="dialog">
  <DIV class="modal-dialog">
    <DIV class="modal-content">
      <DIV class="modal-header">
        <BUTTON class="close2" aria-hidden="true" type="button" data-dismiss="modal">×</BUTTON>
        <H4 class="modal-title">删除模版：</H4>
      </DIV>
      <DIV class="modal-body">
      <span class="text-14px-333">是否删除" XXXXXXX "模版？</span>
      </DIV>
      <DIV class="modal-footer">
        <BUTTON class="btn2 btn-primary" type="button" id="submitBut6" value="0" data-dismiss="modal">确定</BUTTON>
        &nbsp;&nbsp;
